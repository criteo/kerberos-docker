...
public class GssClient {
    ...
    private static class GssClientAction implements PrivilegedExceptionAction {
            ...
            while (!context.isEstablished()) {
                ...
                if (token != null) {
                    if (verbose) {
                        ...
                        System.out.println("writing token = " + Helper.getHexBytes(token));
                    }
                ...
                if (!context.isEstablished()) {
                    ...
                    if (verbose) {
                        System.out.println("reading token = " + Helper.getHexBytes(token));
